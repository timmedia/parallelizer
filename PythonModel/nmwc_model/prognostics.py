...
def prog_isendens(sold, snow, unow, dtdx,nx_p,nb_p, dthetadt=None):
...
def prog_velocity(uold, unow, mtg, dtdx,nx_p,nb_p, dthetadt=None):
    ...
    # *** edit here ***
    #
    i = nb_p + np.arange(0, nx_p + 1)
    k = np.arange(1, nz-1)
    print(i,unow.shape, nx_p)
...
def prog_moisture(unow, qvold, qcold, qrold, qvnow, qcnow, qrnow, dtdx,nx_p,nb_p, dthetadt=None):
...
def prog_numdens(unow, ncold, nrold, ncnow, nrnow, dtdx,nx_p,nb_p, dthetadt=None):
